...
const Terms = () => {
  return (
    <div className="max-w-3xl mx-auto p-5">
      <h1 className="text-4xl font-bold text-center text-gray-700 mt-6">
      ...
      <p className="max-w-2xl text-center text-lg text-gray-600 mb-10 px-4">
        Welcome to SolverSilver. By accessing or using my services, you agree to
      ...
      <p className="mb-4">
        ...
        do not agree with any of these terms, please let us know before using
        our services.
      </p>
      ...
      <p className="mb-4">
        ...
        responsible for your own conduct and any content you submit.
      </p>
      ...
      <p className="mb-4">
        All content, trademarks, and other intellectual property on this site
        are owned by or licensed to SolverSilver. You may not use any content
        without our express written permission.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">5. Payment Terms</h2>
      <p className="mb-4">
        Payment for services is required in advance unless otherwise agreed. All
      ...
      <p className="mb-4">
        SolverSilver shall not be liable for any indirect, incidental, or
      ...
      <p className="mb-4">
        These terms are governed by applicable laws, and any disputes will be
      ...
      <p className="mb-4">
        ...
        <Link to="/contact" className="cursor-pointer underline text-blue-700">
          here
        </Link>
        .
      </p>
