...
function Portfolio() {
  ...
  const reviews = [
    {
      id: 1,
      name: 'Client One',
      review: 'This was an amazing experience! Highly recommend.',
    },
    {
      id: 2,
      name: 'Client Two',
      review: 'Professional and timely work. Very satisfied.',
    },
    {
      id: 3,
      name: 'Client Three',
      review: 'Exceptional service and quality. Will hire again!',
    },
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col items-center py-10">
      ...
      <h2 className="text-3xl font-bold mb-6 text-gray-800">Client Reviews</h2>
