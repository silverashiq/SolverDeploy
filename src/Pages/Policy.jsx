  ...
  return (
    <div className="max-w-3xl mx-auto p-5">
      ...
      <p className="max-w-2xl text-center text-lg text-gray-600 mb-10 px-4">
        Welcome to SolverSilver. Your privacy is important to us. This Privacy
      ...
      <p className="mb-4">
        ...
        and any other information you provide when you contact us or use our
        services.
      </p>
      ...
      <p className="mb-4">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            Send you updates and promotional materials (if you have opted in).
          </li>
      ...
      <p className="mb-4">
        ...
        through email or by placing a notice on our site.
      </p>
