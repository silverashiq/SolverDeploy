...
function Website() {
  const projects = [
    {
      ...
      imageUrl: 'https://res.cloudinary.com/dntx46fvh/image/upload/q_auto/v1733608692/landing-page-design-modern-responsive_hdwifs.png',
      link: '#',
    },
    {
      id: 2,
      ...
      imageUrl: 'https://res.cloudinary.com/dntx46fvh/image/upload/q_auto/v1733608693/business-website-design-professional-responsive_q2tlxw.png',
      link: '#',
    },
    {
      id: 3,
      ...
      imageUrl: 'https://res.cloudinary.com/dntx46fvh/image/upload/q_auto/v1733608693/full-website-redesign-modern-responsive_xvj5cd.png',
      link: '#',
    },
    {
      id: 4,
      ...
      imageUrl: 'https://res.cloudinary.com/dntx46fvh/image/upload/q_auto/v1733608693/ecommerce-website-design-modern-responsive_baotvu.png',
      link: '#',
    },
    {
      id: 5,
      ...
      imageUrl: 'https://res.cloudinary.com/dntx46fvh/image/upload/q_auto/v1733608692/web-application-development-modern-secure_etjmkx.png',
      link: '#',
    },
    {
      id: 6,
      ...
      imageUrl: 'https://res.cloudinary.com/dntx46fvh/image/upload/q_auto/v1733608693/full-stack-development-mern-modern_h2mwu7.png',
      link: '#',
    },
  ...
  <span className='w-[200px] h-[2px] block mt-[35px] mb-[25px] bg-[#D9B592]'></span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12 mx-4 md:mx-14 px-4 mb-10 md:mb-20">
